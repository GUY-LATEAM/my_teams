...
#ifndef MY_TEAMS_CLIENT_EVENTS_H
  #define MY_TEAMS_CLIENT_EVENTS_H
  #include <time.h>

typedef struct client_events_s client_events_t;

struct client_events_s {
...
#endif // MY_TEAMS_CLIENT_EVENTS_H
